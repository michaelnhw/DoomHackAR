...
public class SensorAccessJMEActivity extends AndroidHarness {
    ...
    ByteBuffer mPreviewByteBufferRGB565;
        ...
        public void onSensorChanged(SensorEvent event) {
            ...
            switch(event.sensor.getType()) {
                ...
                case Sensor.TYPE_ROTATION_VECTOR:
                    ...
                    if ((com.example.hermanmak.doomhack.SensorAccessJME) app != null) {
                        ((com.example.hermanmak.doomhack.SensorAccessJME) app).setRotation((float)pitchQ, (float)rollQ, (float)headingQ);
                    }
                    break;
            }
        }
    ...
    private final Camera.PreviewCallback mCameraCallback = new Camera.PreviewCallback() {
        public void onPreviewFrame(byte[] data, Camera c) {
            if (c != null && stopPreview == false) {
                ...
                if ((com.example.hermanmak.doomhack.SensorAccessJME) app != null) {
                    ((com.example.hermanmak.doomhack.SensorAccessJME) app)
    ...
    public SensorAccessJMEActivity() {
        ...
        appClass = "com.example.hermanmak.doomhack.SensorAccessJME";
